...
class Module7 extends PureComponent{
    
    constructor(props){
        console.log('[Module 7] constructor');
        super(props);
        this.state = {
            theme:'light'
        }
    ...
    static getDerivedStateFromProps(props, state) {
        console.log('[Module 7] got props')
        return null;
    }

    // shouldComponentUpdate(nextProps, nextState){
    //     console.log('[Module 7] should component update');

    //     return nextState.movies !== this.state.movies; //; //false;
    // }

    componentDidUpdate(){
        console.log('[Module 7] component did update')
    }
    


    componentDidMount(){
        console.log('[Module 7] component mounted');
    }
    ...
    render(){
        ...
        console.log('[Module 7] component render');
